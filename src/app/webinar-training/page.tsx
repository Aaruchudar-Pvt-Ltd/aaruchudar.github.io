...
export default function WebinarTrainingRequestPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    openMailto("Webinar & Training Request", body);
    setStatus("success");
    form.reset();
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-brand-dark via-brand to-neural-cyan">
        <div className="container mx-auto px-6 py-10 flex items-center gap-4">
          <img src={asset("/logo2.png")} alt="Aaruchudar" className="h-12 w-12 rounded-md shadow-sm object-cover" />
          <div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {status === "success" && (
            <div className="mb-6 rounded-xl bg-emerald-50 px-4 py-3 text-slate-800">
              <p className="font-medium">Your email app should open with the request details.</p>
              <p className="mt-1 text-sm">Send the message to complete your webinar or training request. We will contact you within 48 hours.</p>
            </div>
          )}
          {status === "error" && (
          ...
          <form id="webinar-training-form" onSubmit={handleSubmit} className="rounded-2xl border border-slate-200 bg-white p-5 md:p-6 shadow-sm">
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 flex items-center gap-3">
                <button type="submit" className="inline-flex items-center justify-center rounded-lg bg-indigo-600 px-5 py-2.5 text-white font-medium shadow-sm hover:bg-indigo-700">
                  Request Session
                </button>
