      ...
      <div className={styles.mainContent}>
        <header className={styles.header}>
          <div className={styles.headerContent}>
            ...
            {/* Sample dashboard and home buttons */}
            <div className={styles.headerActions}>
              <a
                href={asset("/Lab-documents/Lab%20(1).pdf")}
                target="_blank"
                rel="noopener noreferrer"
                className={styles.sampleButton}
                aria-label="Open sample dashboard PDF for Lab 1"
              >
                Sample Dashboard
              </a>
          ...
          <div className={styles.brainViewer} style={{ width: '100%', height: '500px', position: 'relative' }}>
            ...
            <button
              ...
              style={{
                ...
                bottom: '20px',
                right: '20px',
                background: autoRotate ? 'rgba(45, 212, 191, 0.3)' : 'rgba(45, 212, 191, 0.15)'
              }}
            >
