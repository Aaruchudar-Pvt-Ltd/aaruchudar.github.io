  ...
  return (
    <div className="min-h-screen bg-page">
      ...
      <div className="fixed bottom-4 left-0 right-0 z-30 flex md:hidden px-4">
        <a
          href="#apply"
          className="flex-1 text-center rounded-full bg-brand text-white py-3 shadow-lg hover:bg-brand-light transition-colors"
        >
          Apply Now
        </a>
      </div>
      ...
      <section className="px-6 md:px-10 lg:px-16 pt-20 md:pt-28 pb-10">
        <div className="mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-3xl bg-brand p-8 md:p-12 shadow-xl">
            <div className="relative z-10">
              <div className="flex items-center gap-3">
                <img src={asset("/logo2.png")} alt="Aaruchudar Logo" className="h-9 w-9 rounded-md shadow-sm" />
              ...
              <div className="mt-6">
                <a
                  href="#apply"
                  className="inline-flex items-center gap-2 rounded-full bg-brand-dark text-white px-5 py-2.5 font-medium shadow-sm hover:bg-[#12203F] transition-colors"
                >
                  Apply Now
                </a>
              </div>
