        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <span className="text-xl font-bold bg-gradient-to-r from-brand to-neural-cyan bg-clip-text text-transparent">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-blue-900 py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={asset("/assets/Franchise.pdf")} download className="px-8 py-4 bg-white text-gray-900 font-bold rounded-xl hover:bg-gray-100 transition-all hover:scale-105">
        ...
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4">
          <div className="relative w-full max-w-4xl">
            ...
            <div className="aspect-video bg-black rounded-xl overflow-hidden">
              <video
                src={asset("/images/VIDEO-2026-01-02-18-47-13.mp4")}
