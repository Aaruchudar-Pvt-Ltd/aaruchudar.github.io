...
export default function ContactPage() {
  ...
  const submitFeedback = () => {
    ...
    openMailto(
      `Feedback from ${feedbackName}`,
      `Name: ${feedbackName}\nEmail: ${feedbackEmail}\nRating: ${rating}/5\n\n${feedback}`,
    );
    setFeedbackStatus("Opening your email app…");
  };
            ...
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm">
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <button
                    type="submit"
                    className="px-4 py-2 rounded-md bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm"
                  >
                    Send
                  </button>
                  <a
