...
export default function Landing() {
  return (
    ...
    {/*      /////////////////////////////////////////////////////////////////                           */}
      ...
      <section className="bg-blue-surface py-20">
        <h2 className="text-center text-3xl font-bold mb-4 text-heading">
          The <span className="text-brand">5 essential</span> cognitive
          skills
        </h2>
        ...
        <div className="text-center mt-10">
          <button className="bg-brand text-white px-8 py-3 rounded-xl">
            Start Training →
          </button>
        </div>
      </section>
      ...
      {/* ================= HERO SECTION ================= */}
      <header className="relative isolate overflow-hidden bg-gradient-to-br from-page via-blue-surface to-mint-surface text-heading">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(37,99,235,0.16),transparent_60%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,rgba(6,182,212,0.14),transparent_60%)]" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-28 pb-28 lg:px-8">
          <div className="max-w-3xl space-y-6">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl leading-tight">
              Unlock <span className="text-brand">Human Intelligence</span>
            </h1>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <Link
                href="/hi-courses"
                className="rounded-xl bg-brand text-white px-6 py-3 shadow-lg hover:bg-brand-light active:scale-[0.98] transition-all flex items-center gap-2"
              >
                Start Training
              </Link>
              ...
              <Link
                href="/internship"
                className="rounded-xl bg-brand-dark text-white px-6 py-3 shadow-lg hover:bg-[#12203F] active:scale-[0.98] transition-all flex items-center gap-2"
              >
            ...
            <div className="mt-10 flex gap-6 text-xs text-slate-500 flex-wrap">
              {["Interactive Labs", "Expert Designed", "Personalized Feedback", "Internships"].map(
                (item) => (
                  <div key={item} className="flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-neural-teal" />
                    {item}
                  </div>
                )
              )}
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          <div className="rounded-2xl bg-white/70 backdrop-blur-xl p-12 shadow-2xl border border-slate-200">
            ...
            <p className="mt-4 text-slate-700 leading-relaxed">
              Explore structured programs and a customized roadmap that helps
              accelerate your cognitive improvement.
            </p>
