import{o as e,t}from"./react-0T9Avz-T.js";import{r as n}from"./index-1310yTba.js";import{t as r}from"./proxy-DjmbE_II.js";var i=e(t(),1),a=n();function o(e,t=[],n){let r=Array.from(new Set(t.filter(Boolean).filter(e=>!n||e!==n))),i=String(e).replace(/\r\n/g,`
`).split(`
`).map(e=>e.trim()),a=[],o=[],s=[],c=null,l=0,u=0,d=()=>{let e=o.join(` `).trim();e&&a.push({type:`p`,text:e}),o=[]},f=()=>{c&&s.length!==0&&(a.push({type:c,items:s}),s=[],c=null)};for(let e of i){if(!e){d(),f();continue}let t=e.match(/^\[(?:image|img)(?::(\d+))?\]$/i);if(t){d(),f();let e=t[1]?Number(t[1])-1:void 0,n=r[e??l];n&&(a.push({type:`img`,src:n}),e===void 0&&l++);continue}let n=e.match(/^(\d+)\.\s+(.+)$/);if(n){d(),c&&c!==`ol`&&f(),c=`ol`,s.push(n[2].trim());continue}let i=e.match(/^[-•]\s+(.+)$/);if(i){d(),c&&c!==`ul`&&f(),c=`ul`,s.push(i[1].trim());continue}let p=/^[-•]/.test(e);if(e.length<=80&&!p&&!/[.!?]$/.test(e)){d(),f(),a.push({type:`h2`,text:e,colorIndex:u%6}),u++;continue}f(),o.push(e)}if(d(),f(),r.length>0&&!a.some(e=>e.type===`img`)){let e=a.filter(e=>e.type===`p`).length;if(e>0){let t=Math.max(1,Math.floor(e/(r.length+1))),n=0,i=0,o=[];for(let s of a)o.push(s),s.type===`p`&&(i++,n<r.length&&i%t===0&&i<e&&(o.push({type:`img`,src:r[n]}),n++));for(;n<r.length;)o.push({type:`p`,text:``}),o.push({type:`img`,src:r[n]}),n++;return o}}return a}function s(){let[e,t]=(0,i.useState)(`All`),[n,s]=(0,i.useState)(``),[c,l]=(0,i.useState)(null),u=`Mapping the Invisible: Visualizing Human Intelligence as the New Standard for Student Performance`,d=[`All`,`Innovation`,`Psychology`,`Intellectual Growth`,`Technology`,`Research`],f=[{id:15,title:`The Science Behind Gut Feeling - Is It Real, or Just in Your Head?`,excerpt:`What gut feeling really is, how intuition forms in the brain, and when to trust it versus question it.`,category:`Psychology`,image:`/Shutterstock_2198678569.jpg`,images:[`/Shutterstock_2198678569.jpg`],tags:[`Intuition`,`Decision Making`,`Neuroscience`,`Self-Awareness`,`Emotional Intelligence`],content:`The Science Behind Gut Feeling - Is It Real, or Just in Your Head?
...
It comes from understanding them.`},{id:14,title:`The Day He Stopped Saying Okay`,excerpt:`A quiet workplace story about how attention, not just knowledge, can change performance and growth.`,category:`Intellectual Growth`,image:`/tired-exhausted-arabic-indian-man-600nw-2163297479.jpg`,images:[`/tired-exhausted-arabic-indian-man-600nw-2163297479.jpg`],tags:[`Workplace Learning`,`Self-Awareness`,`Attention`,`Career Growth`,`Human Intelligence`],content:`The Day He Stopped Saying Okay
...
Because the things we don’t notice don’t disappear. They wait... until they become something we can’t ignore. And by then, it’s no longer small.`},{id:13,title:`The Resume Is Dead: What Actually Gets You Hired Today?`,excerpt:`Why hiring decisions now favor real-world thinking, adaptability, and communication over polished resumes.`,category:`Intellectual Growth`,image:`/images/PHOTO-2026-04-15-18-51-47.jpg`,images:[`/images/PHOTO-2026-04-15-18-51-47.jpg`],tags:[`Hiring`,`Career Readiness`,`Critical Thinking`,`Communication`,`Adaptability`],content:`The Resume Is Dead: What Actually Gets You Hired Today?
...
It’s what you bring to the table when the page is no longer enough.`},{id:10,title:`She Failed 3 Times, Then Her Brain Finally Clicked`,excerpt:`Ananya failed repeatedly, but her brain was adapting in the background. A real story of neuroplasticity, persistence, and progress.`,category:`Intellectual Growth`,image:`/WhatsApp%20Image%202026-04-07%20at%2017.27.25.jpeg`,images:[`/WhatsApp%20Image%202026-04-07%20at%2017.27.25.jpeg`],tags:[`Neuroplasticity`,`Learning`,`Growth Mindset`,`Persistence`],content:`She Failed 3 Times, Then Her Brain Finally Clicked
...
...the moment when everything finally clicks.`},{id:11,title:`Emotions: Your Greatest Strength or Silent Sabotage?`,excerpt:`Emotions are signals, not enemies. Learn how they arise in the brain and how to regulate them without losing clarity.`,category:`Psychology`,image:`/63736b7750723ca6336813d7_Emotional%20dysregulation-min.jpg`,images:[],tags:[`Emotional Intelligence`,`Neuroscience`,`Self-Awareness`,`Regulation`],content:`Emotions: Your Greatest Strength or Silent Sabotage?
    ...
    The choice is not in having emotions but in how you handle them.`},{id:7,title:`The Power of Mental Discipline in a Distracted World`,excerpt:`Mental discipline is quiet control—how to stay steady, focused, and intentional in a world designed to distract you.`,category:`Psychology`,image:`/images/neuro_tech_suite.jpg`,images:[`/images/Blog_%20Mental%20discipline%20/IMG-20260224-WA0015.jpg`,`/images/Blog_%20Mental%20discipline%20/IMG-20260224-WA0016.jpg`,`/images/neurolens_and_band.jpg`],tags:[`Mental Discipline`,`Focus`,`Habits`,`Mindfulness`],content:`The Power of Mental Discipline in a Distracted World
...
And just like the body, the mind can be trained at any age, in everyday life, starting now.`},{id:4,title:`The Cognitive Cost of Constant Screen Exposure`,excerpt:`Exploring how excessive screen time affects focus, memory, and deep thinking, and how to rebuild cognitive health.`,category:`Psychology`,image:`https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&h=600&fit=crop`,images:[`https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&h=700&fit=crop`,`https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1200&h=700&fit=crop`],tags:[`Digital Dementia`,`Neuroscience`,`Focus`,`Memory`],content:`The Cognitive Cost of Constant Screen Exposure
...
Digital tools should serve the human brain not shape it blindly.`},{id:5,title:`The Science Behind Human Intelligence and Learning`,excerpt:`Exploring how the brain grows and adapts through life, and how understanding neuroplasticity can transform learning.`,category:`Psychology`,image:`https://images.unsplash.com/photo-1558478551-1a378f63328e?w=800&h=600&fit=crop`,images:[`https://images.unsplash.com/photo-1558478551-1a378f63328e?w=1200&h=700&fit=crop`,`https://images.unsplash.com/photo-1526378722370-1e7d3d5fb3b1?w=1200&h=700&fit=crop`],tags:[`Neuroplasticity`,`Learning`,`Human Intelligence`],content:`The Science Behind Human Intelligence and Learning
...
Learning in the future is not only about knowledge. It is about developing the brain and the way we think.`},{id:6,title:`Do You Really Know Yourself?`,excerpt:`Exploring the importance of self-awareness in a fast-paced world and how it can transform our lives.`,category:`Psychology`,image:`https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800&h=600&fit=crop`,images:[`https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=1200&h=700&fit=crop`,`https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=1200&h=700&fit=crop`],tags:[`Self-Awareness`,`Personal Growth`,`Mindfulness`],content:`Do You Really Know Yourself?
...
And maybe that is what we need the most today – not more information, but more understanding of who we are.`},{id:8,title:`Neuroplasticity in Action: A New Path for Autism Development`,excerpt:`Training the brain, transforming behavior—how neuroplasticity-guided experiences can support communication, regulation, and learning in autism.`,category:`Research`,image:`/images/hi-labs-banner.jpg`,images:[`/images/Autism and Neuroplasticity images /Neuroplasticity-1-scaled.webp`,`/images/Autism and Neuroplasticity images /puzzle-child-illo-rf-gty-ps-230323_1679581047759_hpMain.jpg`,`/images/Autism and Neuroplasticity images /autism_ninja_1140px.jpg`,`/images/Autism and Neuroplasticity images /qnAvPOCTaZoSYlTL3pKPd_ae6c1601f043490a873e58caa0f1f18c.jpg`,`/images/banner.jpg`],tags:[`Autism`,`ASD`,`Neuroplasticity`,`Brain Training`,`Sensory Integration`,`Human Intelligence Labs`],content:`Neuroplasticity in Action: A New Path for Autism Development
...
The brain can learn, adapt, grow.`},{id:12,title:`Mapping the Invisible: Visualizing Human Intelligence as the New Standard for Student Performance`,excerpt:`Beyond traditional grades—how Power BI dashboards and glassmorphism design transform student performance metrics into actionable insights for personal growth.`,category:`Innovation`,image:`/images/blggpic.png`,tags:[`Data Visualization`,`Human Intelligence`,`Performance Analytics`,`Power BI`,`Education Technology`,`Student Development`],content:`Mapping the Invisible: Visualizing Human Intelligence as the New Standard for Student Performance
...
It is who you are becoming.`}].filter(t=>{let r=e===`All`||t.category===e,i=t.title.toLowerCase().includes(n.toLowerCase())||t.excerpt.toLowerCase().includes(n.toLowerCase())||t.tags.some(e=>e.toLowerCase().includes(n.toLowerCase()));return r&&i}).sort((e,t)=>e.title===u&&t.title!==u?-1:+(t.title===u&&e.title!==u));return(0,a.jsx)(`div`,{className:`blog-container pt-16 md:pt-24 pb-20`,children:c?(0,a.jsxs)(`article`,{className:`full-blog`,children:[(0,a.jsx)(`div`,{className:`full-blog-topbar`,children:(0,a.jsx)(`button`,{onClick:()=>l(null),className:`back-button`,children:`Back to Blogs`})}),(0,a.jsx)(`header`,{className:`full-blog-hero`,children:(0,a.jsxs)(`div`,{className:`full-blog-hero-inner`,children:[(0,a.jsxs)(`div`,{className:`full-blog-meta`,children:[(0,a.jsx)(`span`,{className:`full-blog-category`,children:c.category}),!!c.tags?.length&&(0,a.jsx)(`div`,{className:`full-blog-tags`,children:c.tags.slice(0,6).map((e,t)=>(0,a.jsx)(`span`,{className:`full-blog-tag`,children:e},`${e}-${t}`))})]}),(0,a.jsx)(`h1`,{className:`full-blog-title`,children:c.title}),(0,a.jsx)(`p`,{className:`full-blog-subtitle`,children:c.excerpt}),(0,a.jsx)(`div`,{className:`full-blog-imageWrap`,children:(0,a.jsx)(`img`,{src:c.image,alt:c.title,className:`full-blog-image`})})]})}),(0,a.jsx)(`section`,{className:`full-blog-body`,children:o(c.content,c.images??[],c.image).map((e,t)=>e.type===`h2`?(0,a.jsx)(`h2`,{className:`full-blog-heading color-${e.colorIndex}`,children:e.text},t):e.type===`ul`?(0,a.jsx)(`ul`,{className:`full-blog-list full-blog-list-unordered`,children:e.items.map((e,t)=>(0,a.jsx)(`li`,{className:`full-blog-listItem`,children:e},`${e}-${t}`))},t):e.type===`ol`?(0,a.jsx)(`ol`,{className:`full-blog-list full-blog-list-ordered`,children:e.items.map((e,t)=>(0,a.jsx)(`li`,{className:`full-blog-listItem`,children:e},`${e}-${t}`))},t):e.type===`img`?(0,a.jsx)(`figure`,{className:`full-blog-inlineImageWrap`,children:(0,a.jsx)(`img`,{src:e.src,alt:e.alt??c.title,className:`full-blog-inlineImage`,loading:`lazy`})},t):(0,a.jsx)(`p`,{className:`full-blog-paragraph`,children:e.text},t))})]}):(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(`div`,{className:`search-wrapper`,children:(0,a.jsx)(`input`,{type:`text`,placeholder:`Search articles, topics, or authors...`,value:n,onChange:e=>s(e.target.value),className:`search-input`,"aria-label":`Search blog posts`})}),(0,a.jsx)(`div`,{className:`category-pills`,children:d.map(n=>(0,a.jsx)(`button`,{onClick:()=>t(n),className:`category-pill ${e===n?`active`:``}`,children:n},n))}),(0,a.jsx)(`div`,{className:`blog-grid`,children:f.map(e=>(0,a.jsxs)(r.div,{className:`blog-card`,whileHover:{y:-6},onClick:()=>l(e),children:[(0,a.jsxs)(`div`,{className:`blog-image-wrapper`,children:[(0,a.jsx)(`img`,{src:e.image,alt:e.title,className:`blog-image`}),(0,a.jsx)(`div`,{className:`blog-card-badge`,children:e.category})]}),(0,a.jsxs)(`div`,{className:`blog-info`,children:[(0,a.jsx)(`h3`,{className:`blog-title`,children:e.title}),(0,a.jsx)(`p`,{className:`blog-excerpt`,children:e.excerpt}),!!e.tags?.length&&(0,a.jsx)(`div`,{className:`blog-tags`,children:e.tags.slice(0,3).map((e,t)=>(0,a.jsx)(`span`,{className:`blog-tag`,children:e},`${e}-${t}`))}),(0,a.jsx)(`div`,{className:`blog-card-cta`,children:`Read article`})]})]},e.id))})]})})}export{s as default};