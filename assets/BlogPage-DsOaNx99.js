...
It is who you are becoming.`}].filter(t=>{let r=e===`All`||t.category===e,i=t.title.toLowerCase().includes(n.toLowerCase())||t.excerpt.toLowerCase().includes(n.toLowerCase())||t.tags.some(e=>e.toLowerCase().includes(n.toLowerCase()));return r&&i}).sort((e,t)=>e.title===d&&t.title!==d?-1:+(t.title===d&&e.title!==d));return(0,o.jsx)(`div`,{className:`blog-container pt-16 md:pt-24 pb-20`,children:l?(0,o.jsxs)(`article`,{className:`full-blog`,children:[(0,o.jsx)(`div`,{className:`full-blog-topbar`,children:(0,o.jsx)(`button`,{onClick:()=>u(null),className:`back-button`,children:`Back to Blogs`})}),(0,o.jsx)(`header`,{className:`full-blog-hero`,children:(0,o.jsxs)(`div`,{className:`full-blog-hero-inner`,children:[(0,o.jsxs)(`div`,{className:`full-blog-meta`,children:[(0,o.jsx)(`span`,{className:`full-blog-category`,children:l.category}),!!l.tags?.length&&(0,o.jsx)(`div`,{className:`full-blog-tags`,children:l.tags.slice(0,6).map((e,t)=>(0,o.jsx)(`span`,{className:`full-blog-tag`,children:e},`${e}-${t}`))})]}),(0,o.jsx)(`h1`,{className:`full-blog-title`,children:l.title}),(0,o.jsx)(`p`,{className:`full-blog-subtitle`,children:l.excerpt}),(0,o.jsx)(`div`,{className:`full-blog-imageWrap`,children:(0,o.jsx)(`img`,{src:r(l.image),alt:l.title,className:`full-blog-image`})})]})}),(0,o.jsx)(`section`,{className:`full-blog-body`,children:s(l.content,l.images??[],l.image).map((e,t)=>e.type===`h2`?(0,o.jsx)(`h2`,{className:`full-blog-heading color-${e.colorIndex}`,children:e.text},t):e.type===`ul`?(0,o.jsx)(`ul`,{className:`full-blog-list full-blog-list-unordered`,children:e.items.map((e,t)=>(0,o.jsx)(`li`,{className:`full-blog-listItem`,children:e},`${e}-${t}`))},t):e.type===`ol`?(0,o.jsx)(`ol`,{className:`full-blog-list full-blog-list-ordered`,children:e.items.map((e,t)=>(0,o.jsx)(`li`,{className:`full-blog-listItem`,children:e},`${e}-${t}`))},t):e.type===`img`?(0,o.jsx)(`figure`,{className:`full-blog-inlineImageWrap`,children:(0,o.jsx)(`img`,{src:r(e.src),alt:e.alt??l.title,className:`full-blog-inlineImage`,loading:`lazy`})},t):(0,o.jsx)(`p`,{className:`full-blog-paragraph`,children:e.text},t))})]}):(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(`div`,{className:`search-wrapper`,children:(0,o.jsx)(`input`,{type:`text`,placeholder:`Search articles, topics, or authors...`,value:n,onChange:e=>c(e.target.value),className:`search-input`,"aria-label":`Search blog posts`})}),(0,o.jsx)(`div`,{className:`category-pills`,children:f.map(n=>(0,o.jsx)(`button`,{onClick:()=>t(n),className:`category-pill ${e===n?`active`:``}`,children:n},n))}),(0,o.jsx)(`div`,{className:`blog-grid`,children:p.map(e=>(0,o.jsxs)(i.div,{className:`blog-card`,whileHover:{y:-6},onClick:()=>u(e),children:[(0,o.jsxs)(`div`,{className:`blog-image-wrapper`,children:[(0,o.jsx)(`img`,{src:r(e.image),alt:e.title,className:`blog-image`}),(0,o.jsx)(`div`,{className:`blog-card-badge`,children:e.category})]}),(0,o.jsxs)(`div`,{className:`blog-info`,children:[(0,o.jsx)(`h3`,{className:`blog-title`,children:e.title}),(0,o.jsx)(`p`,{className:`blog-excerpt`,children:e.excerpt}),!!e.tags?.length&&(0,o.jsx)(`div`,{className:`blog-tags`,children:e.tags.slice(0,3).map((e,t)=>(0,o.jsx)(`span`,{className:`blog-tag`,children:e},`${e}-${t}`))}),(0,o.jsx)(`div`,{className:`blog-card-cta`,children:`Read article`})]})]},e.id))})]})})}export{c as default};